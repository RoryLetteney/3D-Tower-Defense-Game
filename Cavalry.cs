...
public class Cavalry : MonoBehaviour {
    ...
    private float baseDamage = PlayerUnitStats.cavalryDamage;
    ...
    void Attack()
    {
        if (waitTime >= 1f)
        {
            ...
            if (target.gameObject.layer == LayerMask.NameToLayer("EnemySwordsmen") || target.gameObject.layer == LayerMask.NameToLayer("EnemyMisc"))
            {
